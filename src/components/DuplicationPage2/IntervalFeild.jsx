  ...
  return (
    <div className="relative mb-4">
      ...
      <div className="flex items-center w-full bg-bgInputFeild p-4 rounded-[5px]">
        ...
        <div
          className="flex gap-2 sm:gap-28 items-end cursor-pointer"
          onClick={dropDownOpen}
        >
          <span className="text-white font-normal text-base leading-[20.11px] font-sourceSans">
            {options}
          </span>
        ...
        <div className="mt-2 w-full bg-[#19222B] rounded-lg shadow-lg">
          <ul className="py-2">
            <li
              ...
              onClick={() => handleOptions("Hour")}
            >
              Hours
            </li>
            <li
              className="px-4 py-2 text-white hover:bg-gray-600 cursor-pointer"
              onClick={() => handleOptions("Minute")}
            >
              Minutes
            </li>
          </ul>
